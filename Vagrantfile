...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "machine1" do |machine1|
    ...
    machine1.vm.synced_folder shared_host_folder, "C:\Users\danil\Desktop\вэки вэки\Мага\Виртуализация и контейнеризация\Prac_4\vagrant-environment\shared", type: "rsync"
  end
  ...
  config.vm.define "machine2" do |machine2|
    ...
    machine2.vm.synced_folder shared_host_folder, "C:\Users\danil\Desktop\вэки вэки\Мага\Виртуализация и контейнеризация\Prac_4\vagrant-environment\shared", type: "rsync"
  end
